	...
	while ( rs.next() )
	   {
		...
		%> 
      <span class="style1">VERIFYING PSEUDO RANDOM KEY</span></p>
  <p>&nbsp;</p>
</div>
<form name="form1" method="post" action="message11.jsp">
  <table width="597" border="1" align="center">
    ...
    <tr>
      <td><span class="style4">Enter your Pseudo Random Key to View:- </span></td>
