...
<html>
    ...
    <body>
        <%    ServletContext context = getServletContext();
            ...
            String dirName = context.getRealPath("/eauthentication/");
            File baseDir = new File(dirName);
            baseDir.mkdirs();
            System.out.println("***************************File stored DIrectory************************");
            System.out.println("Directory Exists: "+baseDir.exists()+" \n File stored DIrectory :" + baseDir.getAbsolutePath());
            try {
                String user = request.getParameter("s1");
                String tname = request.getParameter("t1");
                String msg = request.getParameter("textarea");
                String keys = request.getParameter("t4");
                ...
                PrintStream p = new PrintStream(new FileOutputStream(new File(baseDir, filename)));
                p.print(new String(msg));

                MessageDigest md = MessageDigest.getInstance("SHA1");
                FileInputStream fis11 = new FileInputStream(new File(baseDir, filename));
                ...
                String query = "select * FROM user where uname='" + user + "'";
        ...
        <form action="emsg2.jsp" method="post"  name="form1">
            <table width="612" border="1" align="center">
                <tr>
                    <td width="286"><span class="style4">Reciever Name:-  </span></td>
                    <td width="339"><input type="text" name="t12" id="t12" value="<%= user%>" readonly></td>
                </tr>
                <tr>
                    <td><span class="style4">Reciever Mobile No:- </span></td>
                    <td><input type="text" name="t1" id="t1" value="<%= mob%>" readonly></td>
                </tr>
                <tr>
                    <td><span class="style4">Reciever E-Mail:- </span></td>
                    <td><input type="text" name="t2" id="t2"  value="<%= mail%>" readonly></td>
                </tr>
                <tr>
