    ...
    <body>
        <%    ArrayList list = new ArrayList();
            ...
            try {
                ...
                int lyke = 0;
                //this is the culprit it always saves the secret key as Rejected 
//                String as = "Rejected";
                String as = RandomStringUtils.randomNumeric(6, 6);
        ...
        %>
        <p><a href="upload.jsp">Back</a> <a href="index.html">Home</a> </p>
